...
var _dotenv = _interopRequireDefault(__webpack_require__(46));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {_defineProperty(target, key, source[key]);});}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}

_dotenv.default.config();

exports.handler = function (event, context, callback) {var
  form_id = event.queryStringParameters.form_id;
  var instance = _axios.default.create({ baseURL: process.env.API_URL });

  instance.
  post("".concat(process.env.API_URL, "/jwt-auth/v1/token"), {
  ...
  then(function () {return (
      instance.post("".concat(
      process.env.API_URL, "/gf/v2/forms/").concat(form_id, "/submissions"),
