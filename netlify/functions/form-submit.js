...
"use strict";
var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;}; /* eslint-disable func-names, space-before-function-paren */
var _axios = __webpack_require__(15);var _axios2 = _interopRequireDefault(_axios);
var _dotenv = __webpack_require__(46);var _dotenv2 = _interopRequireDefault(_dotenv);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

_dotenv2.default.config();

exports.handler = function (event, context, callback) {var
  form_id = event.queryStringParameters.form_id;
  var instance = _axios2.default.create({ baseURL: process.env.API_URL });
  ...
  then(function (_ref) {var token = _ref.data.token;
  ...
  then(function (_ref2) {var confirmation_message = _ref2.data.confirmation_message;
